                        ...
                        <form method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="username" placeholder="same as reg no" class="form-control" id="username" value="<?php echo isset($_POST['username']) ? $_POST['username'] : null ?>">
                                </div>
                                <div class="form-group col-md-6">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="roll_no" class="small">Reg No</label>
                                    <input type="text" name="roll_no" placeholder="Reg. no" class="form-control" id="rolln0" value="<?php echo isset($_POST['roll_no']) ? $_POST['roll_no'] : null ?>">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="avatar" class="small">Passport</label>
