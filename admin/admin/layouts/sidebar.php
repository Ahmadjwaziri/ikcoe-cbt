        ...
        <div class="nav">
            ...
            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link" href="add_teacher.php">Add Lecturer</a>
                    <a class="nav-link" href="view_teacher.php">View Lecturer</a>
                </nav>
            </div>
            ...
            <div class="collapse" id="collapseStudent" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
                    ...
                    <a class="nav-link" href="upload_student.php">Upload Student</a>
                </nav>
            </div>
