...
<head>
    ...
    <title>IKCOE E-Test App-Student Area</title>
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group">
                                            <label class="small mb-1" for="inputUsername">Registration Number</label>
                                            <input class="form-control" name="username" value="<?php echo isset($_POST['username']) ? $_POST['username'] : null ?>" id="inputUsername" type="text" placeholder="Enter Reg. No" />
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <input type="hidden" name="status" value="<?php echo $tatus ?>">
                                        <div class="form-group d-flex justify-content-center mt-4 mb-0">
                                            <button class="btn btn-primary px-5" type="submit" name="login"> <i class="fas fa-sign-in-alt"></i> Start Test</button>
                                        </div>
