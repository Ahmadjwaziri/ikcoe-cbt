...
<nav class="navbar sb-topnav navbar-expand navbar-dark bg-navy">
    ...
    <span>  <b> EXAM SESSION </b> </span>
    <!-- Navbar-->
    <ul class="navbar-nav ml-auto">
        <li class="nav-item">
            <a class="nav-link" href="results.php"><i class="fas fa-power-on fa-fw"></i> <b> End Test </b> </a>
        </li>
...
<ul class="navbar-nav ml-auto">
                ...
                <a class="dropdown-item" href="#" onclick="document.getElementById('logout-form').submit();"><i class="fas fa-power-off fa-fw"></i> <b>Logout</b> </a>
            </div>
        </li>
    </ul>
