...
<nav class="navbar sb-topnav navbar-expand navbar-dark bg-navy">
    <a class="navbar-brand" href="index.php">IKCOE E-Test App</a>

    <ul class="navbar-nav mr-auto">
        <li class="nav-item">
            <b>
            <span class="nav-link" style="color:red;"><i class="fas fa-clock fa-fw"></i> <span id="timer">000:00</span> (Time Remaining)</span>
    ...
    <?php
                ...
                if ($student) {
                    ...
                    <br>
                    <?php
                    echo htmlspecialchars($student['roll_no'], ENT_QUOTES, 'UTF-8');
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
        <b>
            <a class="nav-link" href="results.php"><i class="fas fa-power-off fa-fw"></i> End-Test</a>
            </b>
        </li>
    </ul>
...
<div id="layoutSidenav">
    <div id="layoutSidenav_nav">
        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    <div class="sb-sidenav-menu-heading">Questions Index</div>
                    <div class="px-3">
                        <?php
                        if ($questions) {
                            $count = 0;
    ...
    <div id="layoutSidenav_content">
                                    ...
                                    <div class="card-header bg-white py-0">
                                        <div class="row">
                                            <div class="col-md-1 py-1 text-left small border-right">
                                               <b> Question - <?php echo ++$count; ?> <br></b>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label small" for="<?php echo $question['id'] . '_option_a' ?>"><b>Option A</b></label>
                                                </div>
                                                <div class="mt-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label small" for="<?php echo $question['id'] . '_option_b' ?>"><b>Option B</b></label>
                                                </div>
                                                <div class="mt-3">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-6">
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label small" for="<?php echo $question['id'] . '_option_c' ?>"><b>Option C</b></label>
                                                </div>
                                                <div class="mt-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label small" for="<?php echo $question['id'] . '_option_d' ?>"><b>Option D</b></label>
                                                </div>
                                                <div class="mt-3">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-6">
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label small" for="<?php echo $question['id'] . '_skip' ?>"><b>Skip this question</b></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <li class="nav-item">
            <b>
                <center>
            <a class="nav-link" href="results.php" style=" color:red;"><i class="fas fa-power-off fa-fw"></i> End Test</a>
            </center>
            </b>
        </li>
        ...
        function timer() {
            $.post("ajax_timer.php", {
                ...
                if (response.remaining <= 0) {
                    ...
                    Swal.fire({
                        title: 'Time Over!',
                        text: 'Redirecting out of exam session in 5 seconds... Kindly leave the hall',
                        icon: 'warning',
                        timer: 5000,
